...
@Module({imports:[PrismaModule,GeocodificacionModule],controllers:[ManifiestosController],providers:[ManifiestosService,ManifiestosDiagnosticoService,ManifiestosImportacionProgressService,ManifiestoParser],exports:[ManifiestosService,ManifiestoParser,ManifiestosImportacionProgressService]})
