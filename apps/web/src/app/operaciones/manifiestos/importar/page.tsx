  ...
  const generarPreview = async (file: File) => {
    ...
    try {
      ...
      if (!response.ok || !data.ok) {
        throw new Error(
          data.mensaje ?? "No fue posible generar la vista previa.",
        );
      }
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-6">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Cargue un manifiesto XLSX, XLS o CSV para validar e importar sus
            Houses, bultos, personas y pesos.
          </p>
        </div>
        ...
        {cargandoPreview && (
          <section className="mt-6 rounded-2xl border border-blue-200 bg-blue-50 p-6">
            <div className="flex items-center gap-3 text-blue-800">
              ...
              <span className="font-medium">Analizando manifiesto...</span>
            </div>
          </section>
        )}
          ...
          <>
            <section className="mt-6">
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
                ...
                <KpiCard label="Houses" value={preview.total.cantidadHouses} />

                <KpiCard label="Bultos" value={preview.total.cantidadSacas} />
              ...
              <section className="mt-6 rounded-2xl border border-yellow-300 bg-yellow-50 p-5">
                ...
                {preview.duplicado?.masterAwb && (
                  <p className="mt-2 text-sm text-yellow-900">
                    Master AWB: <strong>{preview.duplicado.masterAwb}</strong>
                  </p>
                )}
              </section>
            )}
            ...
            <section className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              <div className="border-b border-slate-200 px-6 py-4">
                ...
                <p className="mt-1 text-sm text-slate-500">
                  {preview.registros ?? 0} registros encontrados.
                </p>
              </div>
            ...
            <section className="mt-6 flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                ...
                disabled={
                  importando || !archivo || preview.archivo?.duplicado === true
                }
              ...
              >
                {importando ? "Importando..." : "Importar Manifiesto"}
              </button>
            </section>
          </>
        )}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-green-800">
                  {resultado.mensaje ?? "Manifiesto importado correctamente."}
                </p>
