...
export default async function DashboardPage() {
  ...
  const { kpis, cobro, destinos, actividad, consistencia } = dashboard;
      ...
      <section className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500 sm:text-base">
            Vista general del estado operativo de SGCI, con indicadores,
            actividad, excepciones y accesos rápidos.
          </p>
        </div>
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-1 text-xs text-slate-500">
                      {item.masterAwb
                        ...
                        : "Sin Master AWB"}{" "}
                      · {item.houses} Houses · {formatKg(item.pesoKg)}
                    </div>
        ...
        >
          <div className="space-y-4">
            <div className="flex items-center justify-between rounded-xl bg-slate-50 p-4">
              <span className="text-sm text-slate-600">Peso manifiestos</span>

              <span className="font-bold text-slate-950">
                {formatKg(consistencia.pesoDesdeManifiestosKg)}
              </span>
            </div>

            <div className="flex items-center justify-between rounded-xl bg-slate-50 p-4">
              <span className="text-sm text-slate-600">Peso guías</span>
            ...
            <div className="flex items-center justify-between rounded-xl bg-slate-50 p-4">
              <span className="text-sm text-slate-600">Bultos manifiestos</span>
            ...
            <div className="flex items-center justify-between rounded-xl bg-slate-50 p-4">
              <span className="text-sm text-slate-600">Bultos guías</span>
            ...
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4">
              ...
              <div className="mt-1 text-xs text-emerald-700">
                Los indicadores se calculan directamente desde PostgreSQL
                mediante Prisma.
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between rounded-xl border border-amber-200 bg-amber-50 p-4">
              <div>
                ...
                <div className="mt-1 text-xs text-amber-700">
                  Existen Houses sin identificación de estado de cobro.
                </div>
              </div>
      ...
      >
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <a
            ...
            className="rounded-xl border border-slate-200 p-4 transition hover:border-slate-300 hover:bg-slate-50"
          >
            <div className="text-sm font-bold text-slate-950">Reportes</div>
